...
resource "aws_secretsmanager_secret_version" "app" {
  ...
  secret_string = jsonencode({
    MCP_SERVER_SECRET = random_password.mcp_secret.result
    DATABASE_URL      = "postgresql://mcp:${random_password.db_password.result}@${aws_db_instance.postgres.address}:5432/mcp_ops"
  })
}
      ...
      secrets = [
        {
          ...
          valueFrom = "${aws_secretsmanager_secret.app.arn}:MCP_SERVER_SECRET::"
        },
        {
          name      = "DATABASE_URL"
